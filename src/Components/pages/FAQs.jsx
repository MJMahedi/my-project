  ...
  return (
    <div className="bg-sky-50">
      ...
      <div className="container mx-auto px-4 pb-8">
        <h1 className="text-3xl font-bold mb-4">Frequently Asked Questions (FAQs) – Millennial Clothing</h1>

        <h2 className="text-2xl font-bold mb-4">General Information</h2>

        <div className="mb-4">
          <h3 className="text-xl font-bold mb-2">1. What is Millennial Clothing?</h3>
          <p>
            Millennial Clothing is a premium fashion brand specializing in stylish apparel for teenagers, young professionals, and bikers. 
        ...
        <div className="mb-4">
          <h3 className="text-xl font-bold mb-2">4. How can I place an order at Millennial Clothing?</h3>
          <p>
        ...
        <div className="mb-4">
          ...
          <p>
            ...
            labels closely. You can also refer to our Care Guide for tips on maintaining your Millennial Clothing items.
          </p>
        </div>
        ...
        <div className="mb-4">
          <h3 className="text-xl font-bold mb-2">15. Is my personal information safe when shopping at Millennial Clothing?</h3>
          <p>
