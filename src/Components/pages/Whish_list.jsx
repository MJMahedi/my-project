...
function Whish_list() {
  ...
  return (
    <div>
      ...
      <section className="bg-sky-50 py-8 antialiased z md:py-16">
        <div className="mx-auto max-w-screen-xl px-4 2xl:px-0">
          <h2 className="text-xl font-semibold text-gray-900 dark:text-white sm:text-2xl">Whish List</h2>
